...
$sent=send_basic_mail('New quote enquiry - Trinetra Fleet Solutions',$fields,$_POST['email']); ack($_POST['email'],clean($_POST['full_name'],120)); if(!$sent) fail('Your enquiry could not be emailed right now. Please call or WhatsApp Trinetra Fleet Solutions.'); ok();
